...
export default function Account (){
    ...
    const changeSubmitBtnProperty = ()=>{
        const submitBtn = document.getElementsByClassName('btn-update-user')
        ...
        <>
            <div className="main-account">
                <div className="account-infos">
                    {
                        previewSource && (
                            <img src={previewSource} alt="mon profil"/>
                        )
                        
                    }
                    
                    <form onSubmit={handleSubmitFile} action="">
                        <input type="file" name="profil image" id="profil-image" value={fileInputState} onChange={handleFileInputChange} />
                ...
                <div className="account-seting">
                        ...
                        <button  className='btn-update-user' onClick={onSubmitUserData} type="submit">Update</button>
                        </form>
                </div>
            </div>
        </>
